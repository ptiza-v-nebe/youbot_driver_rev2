...
void YouBotArmTestWithoutThread::setUp() {
  ...
  updateCycle = 2000;
  ethercatMaster = &EthercatMaster::getInstance("youbot-ethercat.cfg", YOUBOT_CONFIGURATIONS_DIR, false);
...
void YouBotArmTestWithoutThread::youBotArmTest() {
  ...
  LOG(info) << __func__ << "\n";
  YouBotManipulator myArm("youbot-manipulator",YOUBOT_CONFIGURATIONS_DIR);
